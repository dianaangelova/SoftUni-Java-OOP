...
public class ControllerImpl implements Controller {
    ...
    public String addArea(String areaType, String areaName) {
        ...
        } else throw new NullPointerException(INVALID_AREA_TYPE);
    ...
    public String buyFood(String foodType) {
        ...
        if (foodType.equals("Vegetable")) {
            ...
            food = new Meat();
        } else throw new IllegalArgumentException(INVALID_FOOD_TYPE);
    ...
    public String addAnimal(String areaName, String animalType, String animalName, String kind, double price) {
        ...
        } else throw new IllegalArgumentException(INVALID_ANIMAL_TYPE);
        ...
        if (areaAndAnimalAreLandBased) {
            area.addAnimal(animal);
        } else if (areaAndAnimalAreWaterBased) {
            area.addAnimal(animal);
        } else {
            String.format(AREA_NOT_SUITABLE);
        }
    ...
    public String calculateKg(String areaName) {
        ...
        Double sum = area.getAnimals().stream().mapToDouble(a -> a.getKg()).sum();
